class SiteContact extends HTMLElement {
    ...
    connectedCallback() {
        this.innerHTML = `
    <section id="contact"
        class="relative py-24 md:py-32 bg-[#171717] overflow-hidden">
        ...
        <div class="container mx-auto px-6 relative z-10">
            <div class="text-center mb-16" data-aos="fade-up">
                ...
                <h2 class="text-4xl md:text-5xl lg:text-7xl text-white ubuntu-font-bold tracking-tight title leading-tight">
                    Date <span class="text-pink-400 italic"> un toque de dulzura</span>
                </h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6" role="list">
                ...
                <a href="https://www.instagram.com/postres.perla?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
                    target="_blank" class="flex flex-col items-center text-center p-8 bg-white/5 backdrop-blur-md border border-pink-400/50 rounded-[2rem] shadow-2xl hover:bg-white/10 hover:-translate-y-2 transition-all duration-500 group cursor-pointer"
                ...
                <a href="https://pin.it/2vLaI3PUB" target="_blank" 
                    class="flex flex-col items-center text-center p-8 bg-white/5 backdrop-blur-md border border-pink-400/50 rounded-[2rem] shadow-2xl hover:bg-white/10 hover:-translate-y-2 transition-all duration-500 group cursor-pointer"
