...
function renderProductCards(sliderContainerSelector) {
  ...
  function createProductCard(product) {
    ...
    titleLink.className = 'lower-case text-pink-600 font-bold text-xl transition duration-300 block mb-1 ubuntu-font-bold text';
    titleLink.textContent = product.title;
    const description = document.createElement('p');
    description.className = 'text-black-500 text-base mb-3';
